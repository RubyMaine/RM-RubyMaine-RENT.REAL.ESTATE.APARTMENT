...
<div class="col-lg-12">
	<div class="card card-outline rounded-0 card-primary">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label"> Название системы: </label>
			...
			<div class="form-group">
				<label for="" class="control-label"> Политика конфиденциальности: </label>
			...
			<div class="form-group">
				<label for="" class="control-label"> Баннер для Веб-Сайта: </label>
				<div class="custom-file">
			...
			<div class="form-group">
				<label for="" class="control-label"> Слайдер для Веб-Сайта: </label>
				<div class="custom-file">
				...
				<small><i> Выберите загрузку новых изображений слайдер для веб-сайта! </i></small>
			</div>
			<?php 
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="system-frm"><span class="fas fa-check-square"></span> Сохранить </button>
				</div>
			</div>
		</div>
