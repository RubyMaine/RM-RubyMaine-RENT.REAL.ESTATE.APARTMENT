...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-agent">	
				...
				<div class="row">
					<div class="col-md-6">
						<label for="password" class="control-label"> Новый пароль <sup>*</sup></label>
				...
				<div class="row">
					<div class="col-md-6">
						<label for="" class="control-label"> Фотография пользователя <sup>*</sup></label>
				...
				<div class="row">
					<div class="col-md-4">
						<label for="status" class="control-label"> Состояние <sup>*</sup></label>
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="manage-agent"><span class="fas fa-check-square"></span> Сохранить </button>
				</div>
			</div>
		</div>
</div>
