				...
				<tbody>
					...
					?>
						<tr>
							...
							<td align="center">
								 <button type="button" class="btn btn-flat p-1 btn-primary btn-sm dropdown-toggle dropdown-icon" style="border-radius: 5px;" data-toggle="dropdown"><span class="fas fa-exclamation-triangle"></span> Действие <span class="sr-only">Toggle Dropdown</span>
				                  </button>
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item edit_data" href="./?page=agents/manage_agent&id=<?= $row['id'] ?>" ><span class="fa fa-edit text-primary"></span> Редактировать </a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Вы уверены, что хотите удалить этого агента навсегда?","delete_agent",[$(this).attr('data-id')])
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Сведения об агенте обновления","agents/manage_agent.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
