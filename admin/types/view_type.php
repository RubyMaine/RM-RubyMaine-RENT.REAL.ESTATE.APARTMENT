...
<div class="container-fluid">
    ...
    <div class="text-right">
        <button class="btn btn-sm btn-dark bg-gradient-dark btn-flat" style="border-radius: 5px;" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Закрыть </button>
    </div>
</div>