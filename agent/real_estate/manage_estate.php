...
if(isset($_GET['id'])){
    ...
    if($qry->num_rows > 0){
        ...
        echo '<script> alert("Неизвестный идентификатор недвижимости."); location.replace("./?page=real_estate"); </script>';
    }
}
?>
<style>
...
<div class="card card-outline rounded-0 card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Обновление ": "Создайте новый " ?> недвижимость </h3>
	</div>
	<div class="card-body">
		<form action="" id="estate-form">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="type_id" class="control-label"> Тип недвижимости: </label>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="name" class="control-label"> Название имущества: </label>
                        <input type="text" name="name" id="name" style="border-radius: 4px !important;" placeholder="Название имущества ..." class="form-control form-control-sm rounded-0" required value="<?php echo isset($name) ?$name : '' ?>" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="type" class="control-label"> Тип: </label>
                        <input type="text" name="type" id="type" style="border-radius: 4px !important;" placeholder="Тип ..." class="form-control form-control-sm rounded-0" required value="<?php echo isset($type) ?$type : '' ?>" />
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="purpose" id="purpose" style="border-radius: 4px !important;" placeholder="Назначение ..." class="form-control form-control-sm rounded-0" required value="<?php echo isset($purpose) ?$purpose : '' ?>" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="area" class="control-label"> Площадь: </label>
                        <input type="text" name="area" id="area" style="border-radius: 4px !important;" placeholder="Площадь ..." class="form-control form-control-sm rounded-0" required value="<?php echo isset($area) ?$area : '' ?>" />
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea rows="3" name="location" id="location" style="border-radius: 4px !important;" placeholder="Местоположение ..." class="form-control form-control-sm rounded-0" required><?php echo isset($location) ?$location : '' ?></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="sale_price" class="control-label"> Цена продажи: </label>
                        <input type="text" name="sale_price" id="sale_price" style="border-radius: 4px !important;" placeholder="Цена продажи ..." class="form-control form-control-sm rounded-0" required value="<?php echo isset($sale_price) ?$sale_price : '' ?>" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="coordinates" class="control-label"> Местоположение на карты: </label>
                        <input type="text" name="coordinates" id="coordinates" style="border-radius: 4px !important;" placeholder="Местоположение на карты ..." class="form-control form-control-sm rounded-0" required value="<?php echo isset($coordinates) ?$coordinates : '' ?>" />
                    </div>
                </div>
            </div>
            <div class="form-group">
				<label for="description" class="control-label"> Описание: </label>
                <textarea name="description" id="" cols="30" rows="2" style="border-radius: 4px !important;" placeholder="Описание ..." class="form-control form no-resize summernote"><?php echo isset($description) ? $description : ''; ?></textarea>
			</div>
            
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="amenity_ids" class="control-label"> Удобства в помещение: </label>
                        <select name="amenity_ids[]" id="amenity_ids" style="border-radius: 4px !important;" placeholder="Удобства в помещение ..." class="form-control form-control-sm -rounded-0 select2" multiple required>
                        <option value=""></option>
                        <?php
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="control-label"> Главный изображение: </label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="control-label"> Другие изображения: </label>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="custom-select custom-select-sm rounded-0 selevt"  style="border-radius: 4px !important;">
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" style="border-radius: 5px;" form="estate-form"> Сохранить </button>
		<a class="btn btn-flat btn-danger" style="border-radius: 5px;" href="?page=estate"> Oтменить </a>
	</div>
</div>
<script>
    ...
    function delete_img($path){
        ...
        $.ajax({
            ...
            error:err=>{
                console.log(err)
                alert_toast("Произошла ошибка при удалении изображения","error");
                end_loader()
            },
	...
	$(document).ready(function(){
        $('.rem_img').click(function(){
            _conf("Вы уверены, что хотите удалить это изображение навсегда?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
       
        $('.select2').select2({placeholder:"Пожалуйста, выберите здесь ...",width:"relative"})
