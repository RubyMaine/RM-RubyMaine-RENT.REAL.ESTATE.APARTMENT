...
<div class="card card-outline rounded-0 card-primary">
		...
		<div class="container-fluid">
			...
			<form action="" id="manage-agent">	
				...
				<div class="row">
					...
					<div class="col-md-4">
						<label for="lastname" class="control-label"> Очество <sup>*</sup></label>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<label for="cpassword" class="control-label"> Подтвердите новый пароль <sup>*</sup></label>
						<div class="input-group input-group-sm">
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="manage-agent"> Обновление </button>
				</div>
			</div>
		</div>
</div>
