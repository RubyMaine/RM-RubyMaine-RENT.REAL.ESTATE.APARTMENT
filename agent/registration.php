    ...
    <div class="col-6 d-flex flex-column h-100 justify-content-center align-items-center bg-gradient-light">
        <div class="card card-outline card-primary my-2 rounded-0 shadow">
            <div class="card-header rounded-0">
                <h3 class="card-title font-wight-bolder"> Регистрация нового агента </h3>
            </div>
            <div class="card-body">
                <form id="aregistration-frm" action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label for="contact" class="control-label"> Контактный номер <sup>*</sup></label>
                            <input type="text" name="contact" id="contact" class="form-control form-control-sm rounded-0" required="required">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <label for="address" class="control-label"> Адрес <sup>*</sup></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="email" class="control-label"> Электронная почта <sup>*</sup></label>
                            <input type="email" name="email" id="email" class="form-control form-control-sm rounded-0" required="required">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <label for="password" class="control-label"> Пароль <sup>*</sup></label>
                        ...
                        <div class="col-md-6">
                            <label for="cpassword" class="control-label"> Подтвердите пароль <sup>*</sup></label>
                            <div class="input-group input-group-sm">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="" class="control-label"> Фотографии агента: </label>
                    ...
                    <div class="col-7 text-left">
                        <a class="btn btn-primary" href="<?php echo base_url ?>agent"><i class="fas fa-user-tie"></i> У вас уже есть учетная запись? </a>
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="col-12 text-center p-1">
                        <a class="btn btn-danger btn-block" href="<?php echo base_url ?>"><i class="fas fa-globe-americas"></i> Перейти на веб сайт </a>
                    </div>
                </form>
            </div>
            <!-- /.card-body -->
